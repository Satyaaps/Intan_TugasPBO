...
//        new object
        ...
        while(loggiedin == false) {
            ...
            if (user.equals(user1.getUser()) && password.equals(user1.getPassword_user()) || user.equals(user1.getAdmin()) && password.equals(user1.getPassword_admin())) {
                int ulang;
                loggiedin = true;
                ...
                } else if (user.equals(user1.getAdmin())) {
                    do {
